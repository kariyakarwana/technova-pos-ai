...
The multi-horizon request needs at least 28 actual daily demand values in chronological order. A
365-day request is the default. The returned stock plan uses the supplier lead time, review period,
service level, current stock, and forecast demand to calculate its reorder point and recommended
order quantity.
